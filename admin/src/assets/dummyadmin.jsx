...
export const navLinks = [
    { name: 'Add Items', href: '/additems', icon: <FiPlusCircle /> },
...
export const styles = {
    ...
    // AdminNavbar styles
    navWrapper: "bg-[#2D1B0] border-b-8 border-amber-900/40 shadow-lg sticky top-0 z-50 font-vibes",
...
export const paymentMethodDetails = {
    cod: {
        label: 'COD',
        class: 'bg-yellow-50 text-yellow-600 border-yellow-500/50',
    },
    card: {
